defmodule Prehen.Gateway.Supervisor do
  ...
  def init(opts) do
    children = [
      {Prehen.Agents.Registry, registry_opts(opts)},
  ...
  @doc false
  def registry_opts(opts) do
    [
      profiles: Keyword.get(opts, :agent_profiles, []),
      implementations: Keyword.get(opts, :agent_implementations, [])
    ]
  end
end
